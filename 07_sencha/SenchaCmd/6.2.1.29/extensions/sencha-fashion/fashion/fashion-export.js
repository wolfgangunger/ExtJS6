        ...
        function s(o, u) {
            ...
            var Runtime = function (_Base2) {
                ...
                _createClass(Runtime, [{
                    ...
                    key: "applySplatArgs",
                    value: function applySplatArgs(args) {
                        var newArgs = [],
                            arg,
                            a,
                            item,
                    ...
                    key: "warn",
                    value: function warn() {
                        Fashion.warn.apply(Fashion, arguments);
                    }
                }, {
                    key: "debug",
            ...
            var List = function (_Type6) {
                ...
                _createClass(List, [{
                    ...
                    value: function clone(match, replace) {
                        ...
                        for (var i = 0; i < len; i++) {
                            newItems.push(items[i].clone(match, replace));
                        }
            ...
            var SourceBuilder = function (_TypeVisitor) {
                ...
                function SourceBuilder(cfg) {
                    ...
                    return _possibleConstructorReturn(this, (SourceBuilder.__proto__ || Object.getPrototypeOf(SourceBuilder)).call(this, cfg));
                }
